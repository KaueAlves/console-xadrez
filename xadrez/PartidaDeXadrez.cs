...
namespace xadrez{
    class PartidaDeXadrez{
        ...
        private void colocarPecas(){
            ...
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaoXadrez('g', 2).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaoXadrez('h', 2).toPosicao());
            ...
            tab.colocarPeca(new Torre(tab, Cor.Branca), new PosicaoXadrez('f', 7).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Branca), new PosicaoXadrez('g', 7).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Branca), new PosicaoXadrez('h', 7).toPosicao());
